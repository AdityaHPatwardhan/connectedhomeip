              ...
              EVP_PKEY * newKey, CertStructConfig & certConfig)
{
    ...
    {
        const EVP_MD * md = (EVP_PKEY_is_a(caKey, "ML-DSA-44") || EVP_PKEY_is_a(caKey, "ML-DSA-65"))
            ? nullptr
            : certConfig.GetSignatureAlgorithmDER();
                       ...
                       MutableByteSpan & chipCert)
{
    ...
    bool isMLDSAKey = EVP_PKEY_is_a(newKey, "ML-DSA-44") || EVP_PKEY_is_a(newKey, "ML-DSA-65");
    ...
    if (!useCompactIdentityFormat)
    {
        ...
        if (isMLDSAKey)
        {
            ...
            if (EVP_PKEY_is_a(newKey, "ML-DSA-44"))
    ...
    // public key
    {
        ...
        ReturnErrorOnFailure(writer.PutBytes(ContextTag(kTag_EllipticCurvePublicKey), pubkeyData, pubkeyLen));
    }
